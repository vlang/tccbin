...
## /usr/lib/riscv64-linux-gnu on Debian/Ubuntu
...
./configure \
            --prefix=$TCC_FOLDER \
            --bindir=$TCC_FOLDER \
            --crtprefix=$TCC_FOLDER/lib:/usr/lib/riscv64-linux-gnu:/usr/lib64:/usr/lib:/lib/riscv64-linux-gnu:/lib \
            --libpaths=$TCC_FOLDER/lib/tcc:$TCC_FOLDER/lib:/usr/lib/riscv64-linux-gnu:/usr/lib64:/usr/lib:/lib/riscv64-linux-gnu:/lib:/usr/local/lib/riscv64-linux-gnu:/usr/local/lib \
            --extra-cflags=-O3 \
            --config-bcheck=yes \
